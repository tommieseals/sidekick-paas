...
|------|----------|-------------|------|--------|--------|
| MAC MINI | Mac Mini (M-chip, 16GB RAM) | 100.88.105.106 | Orchestrator — LLM Gateway, Clawdbot, Watchdog, Dashboard | phi3:mini (2.3GB), qwen2.5:3b (1.9GB), nomic-embed-text (0.3GB) | ✅ Operational |
| MAC PRO | Mac Pro | 100.101.89.80 | Compute — Heavy models, code tasks, complex reasoning | deepseek-coder:6.7b, qwen2.5:7b, llama2 (12.3GB total) | ⏳ Pending setup |
