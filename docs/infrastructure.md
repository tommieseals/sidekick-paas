...
| **Mac Pro** | - | 100.67.192.21 | Compute node, heavy model inference | 32GB | 466GB |
...
### Mac Pro (100.67.192.21) — "COMPUTE"
**Role:** Heavy model inference

**SSH Access:** `ssh administrator@100.67.192.21`
...
ssh mac-pro       # 100.67.192.21 (user: administrator)
